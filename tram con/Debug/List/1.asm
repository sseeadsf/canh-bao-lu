...
_0x0:
	...
	.DB  0x21,0x43,0x0,0x63,0x6D,0x0,0x25,0x75
	.DB  0x0,0x25,0x75,0x20,0x20,0x0,0x2A,0x20
	.DB  0x0,0x25,0x64,0x20,0x0,0x52,0x61,0x69
	.DB  0x6E,0x20,0x0,0x53,0x75,0x6E,0x20,0x0
_0x2000060:
	.DB  0x1
_0x2000000:
...
; 0000 00F3 RF_Init_RX();
	RCALL _RF_Init_RX
; 0000 00F4 RF_Config_TX();
	RCALL _RF_Config_TX
; 0000 00F5 RF_Mode_TX();
	RCALL _RF_Mode_TX
; 0000 00F6 border();
	RCALL _border
; 0000 00F7 while (1){
_0xD6:
; 0000 00F8         if(DHT_GetTemHumi(&dht_nhiet_do,&dht_do_am)){
	LDI  R30,LOW(5)
	LDI  R31,HIGH(5)
	RCALL SUBOPT_0x11
	LDI  R26,LOW(4)
	...
	CPI  R30,0
	BREQ _0xD9
; 0000 00F9             sprintf(buff, "%u", (unsigned int)dht_do_am);
	RCALL SUBOPT_0x12
	__POINTW1FN _0x0,38
	RCALL SUBOPT_0x11
	MOV  R30,R4
	RCALL SUBOPT_0x13
; 0000 00FA             glcd_moveto(50, 28);
	LDI  R26,LOW(28)
	RCALL SUBOPT_0x14
; 0000 00FB             glcd_outtext(buff);
; 0000 00FC             sprintf(buff, "%u  ", (unsigned int)dht_nhiet_do);
	RCALL SUBOPT_0x12
	__POINTW1FN _0x0,41
	RCALL SUBOPT_0x11
	MOV  R30,R5
	RCALL SUBOPT_0x13
; 0000 00FD             glcd_moveto(50, 18);
	LDI  R26,LOW(18)
	RCALL SUBOPT_0x14
; 0000 00FE             glcd_outtext(buff);
; 0000 00FF         }
; 0000 0100 
; 0000 0101         set_up_sieu_am();
_0xD9:
	RCALL _set_up_sieu_am
; 0000 0102         glcd_moveto(50, 37);
	LDI  R30,LOW(50)
	ST   -Y,R30
	LDI  R26,LOW(37)
	RCALL _glcd_moveto
; 0000 0103         if((int)distance > 20)
	RCALL SUBOPT_0x15
	SBIW R30,21
	BRLT _0xDA
; 0000 0104             sprintf(buff, "* ");
	RCALL SUBOPT_0x12
	__POINTW1FN _0x0,46
	RCALL SUBOPT_0x11
	LDI  R24,0
...
; 0000 0105         else
	RJMP _0xDB
_0xDA:
; 0000 0106             sprintf(buff, "%d ", (int)distance);
	RCALL SUBOPT_0x12
	__POINTW1FN _0x0,49
	RCALL SUBOPT_0x11
	RCALL SUBOPT_0x15
	...
	RCALL _sprintf
	ADIW R28,8
; 0000 0107         glcd_outtext(buff);
_0xDB:
	LDI  R26,LOW(_buff)
	LDI  R27,HIGH(_buff)
	RCALL _glcd_outtext
; 0000 0108 
; 0000 0109         glcd_moveto(55, 3);
	LDI  R30,LOW(55)
	RCALL SUBOPT_0xB
	RCALL _glcd_moveto
; 0000 010A         //sprintf(buff, "%d ", (int)read_adc(6)/3);
; 0000 010B         //glcd_outtext(buff);
; 0000 010C 
; 0000 010D 
; 0000 010E         if((int)read_adc(6)/3 < 200){
	LDI  R26,LOW(6)
	RCALL _read_adc
	MOVW R26,R30
	LDI  R30,LOW(3)
	...
	CPC  R31,R26
	BRGE _0xDC
; 0000 010F             data_send.light = 1;
	RCALL SUBOPT_0x16
	RCALL SUBOPT_0x17
; 0000 0110             glcd_outtext("Rain ");
	__POINTW2MN _0xDD,0
	RJMP _0xE0
; 0000 0111         }
; 0000 0112         else{
_0xDC:
; 0000 0113             data_send.light = 0;
	__GETD1N 0x0
	RCALL SUBOPT_0x17
; 0000 0114             glcd_outtext("Sun ");
	__POINTW2MN _0xDD,6
_0xE0:
	RCALL _glcd_outtext
; 0000 0115         }
; 0000 0116 
; 0000 0117         data_send.flag = 1;
	RCALL SUBOPT_0x16
	STS  _data_send,R30
	STS  _data_send+1,R31
	STS  _data_send+2,R22
	STS  _data_send+3,R23
; 0000 0118         data_send.temp = (long int)dht_nhiet_do;
	MOV  R30,R5
	LDI  R31,0
	RCALL __CWD1
	__PUTD1MN _data_send,12
; 0000 0119         data_send.humi = (long int)dht_do_am;
	MOV  R30,R4
	LDI  R31,0
	RCALL __CWD1
	__PUTD1MN _data_send,8
; 0000 011A 
; 0000 011B         data_send.sm = (long int)read_adc(7)/4;
	LDI  R26,LOW(7)
	RCALL _read_adc
	RCALL SUBOPT_0x18
	__GETD1N 0x4
...
; 0000 011C         data_send.water = (long int)distance;
	RCALL SUBOPT_0x15
	__PUTD1MN _data_send,20
; 0000 011D 
; 0000 011E         RF_Send_TX(data_send);
