...
;#define MISO PIND.1
;#define IRQ PINB.7
;unsigned char P_Add=0xA3, Code_tay_cam1, Code_tay_cam2 = 0xA2, Code_tay_cam3, Code_tay_cam4;
;#include <nrf_code.h>
_config:
; .FSTART _config
	RCALL SUBOPT_0x5
...
; .FEND
;	Address -> Y+0
_RF_Write_Address_TX_2:
; .FSTART _RF_Write_Address_TX_2
	ST   -Y,R26
;	Address -> Y+1
;	Address2 -> Y+0
	CBI  0x12,4
...
;
;void set_up_sieu_am(){
; 0000 003E void set_up_sieu_am(){
_set_up_sieu_am:
; .FSTART _set_up_sieu_am
; 0000 003F     TRIGGER = 0;
	CBI  0x18,5
; 0000 0040     delay_us(2);
	__DELAY_USB 5
; 0000 0041     TRIGGER = 1;
	SBI  0x18,5
...
; 0000 004A interrupt [10] void timer2_ovf(){
_timer2_ovf:
; .FSTART _timer2_ovf
	ST   -Y,R0
	ST   -Y,R1
...
_0xD1:
	RJMP _0xD0
_0xD2:
; 0000 004F     distance = dem*0.05*3.432*50;
	LDS  R30,_dem
	LDS  R31,_dem+1
	RCALL __CWD1
	RCALL __CDF1
...
; 0000 005A // Variable used to store graphic display
; 0000 005B // controller initialization data
; 0000 005C GLCDINIT_t glcd_init_data;
; 0000 005D 
...
; 0000 0061 DDRB=(0<<DDB7) | (1<<DDB6) | (1<<DDB5) | (0<<DDB4) | (0<<DDB3) | (0<<DDB2) | (0<<DDB1) | (0<<DDB0);
	SBIW R28,8
;	glcd_init_data -> Y+0
	LDI  R30,LOW(96)
	OUT  0x17,R30
; 0000 0062 // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=T Bit0=T
; 0000 0063 PORTB=(1<<PORTB7) | (1<<PORTB6) | (1<<PORTB5) | (1<<PORTB4) | (0<<PORTB3) | (0<<PORTB2) | (0<<PORTB1) | (0<<PORTB0);
	LDI  R30,LOW(240)
	OUT  0x18,R30
; 0000 0064 
; 0000 0065 // Port C initialization
; 0000 0066 // Function: Bit6=In Bit5=In Bit4=In Bit3=In Bit2=In Bit1=In Bit0=In
; 0000 0067 DDRC=(0<<DDC6) | (1<<DDC5) | (0<<DDC4) | (0<<DDC3) | (0<<DDC2) | (0<<DDC1) | (0<<DDC0);
	LDI  R30,LOW(32)
	OUT  0x14,R30
; 0000 0068 // State: Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=T Bit0=T
; 0000 0069 PORTC=(0<<PORTC6) | (1<<PORTC5) | (0<<PORTC4) | (0<<PORTC3) | (0<<PORTC2) | (0<<PORTC1) | (0<<PORTC0);
	OUT  0x15,R30
; 0000 006A 
; 0000 006B // Port D initialization
; 0000 006C // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=In Bit2=In Bit1=In Bit0=In
; 0000 006D DDRD=(0<<DDD7) | (0<<DDD6) | (0<<DDD5) | (1<<DDD4) | (1<<DDD3) | (1<<DDD2) | (0<<DDD1) | (0<<DDD0);
	LDI  R30,LOW(28)
	OUT  0x11,R30
; 0000 006E // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=T Bit0=T
; 0000 006F PORTD=(0<<PORTD7) | (0<<PORTD6) | (0<<PORTD5) | (1<<PORTD4) | (1<<PORTD3) | (1<<PORTD2) | (1<<PORTD1) | (0<<PORTD0);
	LDI  R30,LOW(30)
	OUT  0x12,R30
; 0000 0070 
...
; 0000 0074 TCCR0=(0<<CS02) | (1<<CS01) | (0<<CS00);
	LDI  R30,LOW(2)
	OUT  0x33,R30
; 0000 0075 TCNT0=0xCE;
	LDI  R30,LOW(206)
	OUT  0x32,R30
; 0000 0076 
...
; 0000 0099 TIMSK=(0<<OCIE2) | (0<<TOIE2) | (0<<TICIE1) | (0<<OCIE1A) | (0<<OCIE1B) | (0<<TOIE1) | (1<<TOIE0);
	LDI  R30,LOW(1)
	OUT  0x39,R30
; 0000 009A 
...
; 0000 00A6 // The Analog Comparator's positive input is
; 0000 00A7 // connected to the AIN0 pin
; 0000 00A8 // The Analog Comparator's negative input is
; 0000 00A9 // connected to the AIN1 pin
; 0000 00AA ACSR=(1<<ACD) | (0<<ACBG) | (0<<ACO) | (0<<ACI) | (0<<ACIE) | (0<<ACIC) | (0<<ACIS1) | (0<<ACIS0);
	LDI  R30,LOW(128)
	OUT  0x8,R30
; 0000 00AB 
; 0000 00AC // ADC initialization
; 0000 00AD // ADC Clock frequency: 1000.000 kHz
; 0000 00AE // ADC Voltage Reference: AREF pin
; 0000 00AF ADMUX=ADC_VREF_TYPE;
	LDI  R30,LOW(0)
	OUT  0x7,R30
; 0000 00B0 ADCSRA=(1<<ADEN) | (0<<ADSC) | (0<<ADFR) | (0<<ADIF) | (0<<ADIE) | (0<<ADPS2) | (1<<ADPS1) | (1<<ADPS0);
	LDI  R30,LOW(131)
	OUT  0x6,R30
...
; 0000 00B9 TWCR=(0<<TWEA) | (0<<TWSTA) | (0<<TWSTO) | (0<<TWEN) | (0<<TWIE);
	OUT  0x36,R30
; 0000 00BA 
; 0000 00BB // Graphic Display Controller initialization
; 0000 00BC // The PCD8544 connections are specified in the
; 0000 00BD // Project|Configure|C Compiler|Libraries|Graphic Display menu:
; 0000 00BE // SDIN - PORTC Bit 3
; 0000 00BF // SCLK - PORTC Bit 4
; 0000 00C0 // D /C - PORTC Bit 2
; 0000 00C1 // /SCE - PORTC Bit 1
; 0000 00C2 // /RES - PORTC Bit 0
; 0000 00C3 
; 0000 00C4 // Specify the current font for displaying text
; 0000 00C5 glcd_init_data.font=font5x7;
	LDI  R30,LOW(_font5x7*2)
	LDI  R31,HIGH(_font5x7*2)
	ST   Y,R30
	STD  Y+1,R31
; 0000 00C6 // No function is used for reading
; 0000 00C7 // image data from external memory
; 0000 00C8 glcd_init_data.readxmem=NULL;
	LDI  R30,LOW(0)
	STD  Y+2,R30
	STD  Y+2+1,R30
; 0000 00C9 // No function is used for writing
; 0000 00CA // image data to external memory
; 0000 00CB glcd_init_data.writexmem=NULL;
	STD  Y+4,R30
	STD  Y+4+1,R30
...
; 0000 00D3 #asm("sei")
	sei
; 0000 00D4 
; 0000 00D5 glcd_init(&glcd_init_data);
	MOVW R26,R28
	RCALL _glcd_init
; 0000 00D6 PORTC.5 = 0;
	CBI  0x15,5
...
; 0000 00DA RF_Init_RX();
	RCALL _RF_Init_RX
; 0000 00DB RF_Config_TX_2();
	RCALL _RF_Config_TX_2
...
; 0000 010D 
; 0000 010E         RF_Send_TX_2(data_send);
