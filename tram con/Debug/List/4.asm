...
_0x0:
	.DB  0x4E,0x6F,0x64,0x65,0x3A,0x20,0x0,0x34
...
;#define MISO PIND.1
;#define IRQ PINB.7
;unsigned char P_Add=0xA4, Code_tay_cam1, Code_tay_cam2=0xA2, Code_tay_cam3, Code_tay_cam4;
;#include <nrf_code.h>
_config:
; .FSTART _config
	RCALL SUBOPT_0x5
...
; 0000 00D2 glcd_init_data.vlcd=68;
	LDD  R30,Y+7
	ANDI R30,LOW(0x80)
	ORI  R30,LOW(0x44)
	STD  Y+7,R30
